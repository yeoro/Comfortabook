package com.gucci.cb.config.social;
	...
	KAKAO {
		...
		public ClientRegistration.Builder getBuilder() {
			return getBuilder("kakao", ClientAuthenticationMethod.POST)
					...
					.authorizationUri("https://kauth.kakao.com/oauth/authorize") // authorization code 얻는 API (login)
					.tokenUri("https://kauth.kakao.com/oauth/token") // access Token 얻는 API (token)
					.userInfoUri("https://kapi.kakao.com/v2/user/me") // 유저 정보 조회 API (profile)
